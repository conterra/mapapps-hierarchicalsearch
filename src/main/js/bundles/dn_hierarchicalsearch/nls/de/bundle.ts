...
module.exports = {
    ...
    bundleDescription: "Die Hierarchische Suche erm\u00f6glicht es Features basierend auf den Attributen eines Layers zu suchen.",
    tool: {
    ...
    ui: {
        search: "Suchen",
        displaysearch: "Im Ergebniscenter anzeigen",
